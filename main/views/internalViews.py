...
def setUpDb(request):
    ...
    rayban = Product(category = glasses, name='rayban glasses', brand = 'rayban', url='www.rayban.com', photo='rayban.jpg', overlay='rayban.ol.jpg', price = 129.9, description='stylish rayban')
    ...
    adidas = Product(category = hats, name='adidas cap', brand = 'adidas', url='www.adidas.com', photo='addidas.jpg', overlay='addidasol.jpg', price = 56.9, description ='adidas cap!')
    ...
    beats = Product(category = headphones, name='beats headphones', brand = 'beats', url='www.beats.com', photo='beats.jpg', overlay='beatsol.jpg', price = 256.9, description='stylish headphones!')
